...
function App() {
  ...
  return <>
    <header className="header"><a href="#home" className="wordmark" aria-label="Prothit Halder home">ph<span>↗</span></a><nav aria-label="Main navigation" className={menu ? 'nav open' : 'nav'}><a href="#work" onClick={() => setMenu(false)}>The work</a><a href="#about" onClick={() => setMenu(false)}>The person</a><a href="#off-clock" onClick={() => setMenu(false)}>Off the clock</a></nav><a className="hello-link" href={links.email}>Say hello <ArrowUpRight size={17}/></a><button className="mobile-toggle" aria-label={menu ? 'Close menu' : 'Open menu'} aria-expanded={menu} onClick={() => setMenu(!menu)}>{menu ? <X/> : <Menu/>}</button></header>
    <main>
      <section id="home" className="hero wrap">
        <div className="hero-copy"><div className="eyebrow"><span className="mini-line"/> PRODUCT MINDSET. ENGINEERING DEPTH.</div><h1>Prothit<br/><span className="surname">Halder<span className="accent period">.</span></span></h1><p className="hero-description">Turning customer problems<br/>into products that deliver.</p><div className="hero-meta"><span>CS at Penn</span><span>Previously PayPal</span></div><a href="#work" className="primary-button">Explore my work <ArrowDown size={18}/></a></div>
        ...
        <div className="hero-bottom"><span>BAY AREA <span className="city-separator">/</span> AUSTIN <span className="city-separator">/</span> SAN DIEGO <span className="city-separator">/</span> PHILADELPHIA</span> <a href="#work">SCROLL TO DISCOVER <ArrowDown size={14}/></a></div>
      </section>
      <section id="work" className="work section wrap"><div className="section-kicker"><span>01 / THE WORK</span><span>IDEAS → REAL-WORLD IMPACT</span></div><div className="section-title"><h2>Built with intention.</h2><p>Customer problems. Cross-functional launches.<br/>Measurable product outcomes.</p></div>
      ...
      <section id="about" className="about section"><div className="wrap"><div className="section-kicker"><span>02 / THE PERSON</span><span>A WORK IN PROGRESS. IN A GOOD WAY.</span></div><div className="about-grid"><div><h2>Product ambition.<br/><span className="muted">Technical depth.</span></h2><p className="about-intro">I’m a product-minded engineer moving toward product management, with experience turning merchant needs into products at PayPal.</p><p>Now pursuing my master’s at Penn with a focus on AI, I’m building on that foundation: understanding customer problems, aligning teams, testing ideas, and taking products from ambiguity to launch.</p><div className="career-focus"><span className="eyebrow">WHAT I’M WORKING TOWARD</span><ol><li><strong>Product Manager</strong></li><li>Tech Consultant</li><li>Forward Deployed Engineer</li><li>Product Engineer</li></ol></div></div><div className="education"><span className="eyebrow">THE LEARNING NEVER STOPS</span><article><span className="school-mark"><img src={`${import.meta.env.BASE_URL}penn-shield.png`} alt="University of Pennsylvania shield" width="96" height="64" /></span><div><span className="school-dates">Aug 2026 — Dec 2027 · EXPECTED</span><h3>University of Pennsylvania</h3><p>M.S.E. Computer & Information Science<br/>Concentration in AI</p><span className="school-note">Artificial Intelligence · Software Foundations<br/>Product Design at Wharton · Product Spaces</span></div></article><article><span className="school-mark"><img src={`${import.meta.env.BASE_URL}ucsd-logo.svg`} alt="UC San Diego logo" width="96" height="64" /></span><div><span className="school-dates">2019 — 2022</span><h3>UC San Diego</h3><p>B.S. Mathematics–Computer Science<br/>Minor in Cognitive Science</p><span className="school-note">Cum Laude · Marshall College Honors</span></div></article></div></div></div></section>
